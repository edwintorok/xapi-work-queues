...
(* OASIS_START *)
(* DO NOT EDIT (digest: cfb2c6f61b488b8d2fd2e31d1020cc7a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xapi-project/xapi-work-queues";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Work queues shared between multiple xapi projects"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               ...
               Executable
                 ({
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("oUnit",
                               Some (OASISVersion.VGreaterEqual "2.0.0"));
                           InternalLibrary "xapi_work_queues"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "xwq_test.ml"});
               Test
                 ({
                     cs_name = "xwq_test";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xapi-project/xapi-work-queues.git";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "~ZY\249\176\157Z\200G\029\237T\129\191\006!";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
